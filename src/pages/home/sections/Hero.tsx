...
export function Hero() {
  return (
    <section
      ...
      className="relative flex h-[634px] flex-col justify-center overflow-clip rounded-[24px] px-6 md:h-[772px] md:px-[72px]"
    >
      <picture>
      ...
      <div className="relative flex flex-col items-start gap-6 md:gap-7 md:pb-[34px]">
        <h1 className="font-display text-text-white text-[28px] leading-8 font-light md:text-[65px] md:leading-[86px]">
