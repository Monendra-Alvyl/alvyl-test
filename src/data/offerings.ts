...
export const offerHero = {
  ...
  image: '/assets/offerings/hero-studio.jpg',
...
export const ordinary = {
  ...
  mockups: [
    { src: '/assets/offerings/mockup-stack.jpg', alt: 'Investment app screen on a phone' },
    {
      src: '/assets/offerings/mockup-wealth.jpg',
      alt: 'Asset allocation app screen held in a hand',
    },
    { src: '/assets/offerings/mockup-hand.jpg', alt: 'Alvyl website shown on a phone' },
  ],
}
...
export const goals = {
  ...
  cards: [
    ...
    },
    {
      ...
      image: '/assets/home/offer-sphere-small.png',
    },
    {
      tone: 'dark',
...
export const estimate = {
  ...
  image: '/assets/offerings/calculator.jpg',
}
